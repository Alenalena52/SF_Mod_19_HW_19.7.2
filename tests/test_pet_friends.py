...
def test_add_pets_with_valid_data(name='Ben', animal_type='cat', age='1', pet_photo='images/Ben.jpg'):
...
def test_delete_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pets(api_key, 'Ben', 'cat', '1', 'images/Ben.jpg')
        _, my_pets = pf.get_list_of_pets(api_key, 'my_pets')
...
def test_add_pets_with_valid_data_without_photo(name='ПитомецБезФото', animal_type='кот', age='3'):
...
def test_add_photo_at_pet(pet_photo='images/Cezar.jpg'):
...
def test_add_pet_negative_age_number(name='Ben', animal_type='cat', age='-3', pet_photo='images/Ben.jpg'):
...
def test_add_pet_with_four_digit_age_number(name='Ben', animal_type='cat', age='5263', pet_photo='images/Ben.jpg'):
...
def test_add_pet_with_empty_value_in_variable_name(name='', animal_type='cat', age='2', pet_photo='images/Ben.jpg'):
...
def test_add_pet_with_a_lot_of_words_in_variable_name(animal_type='cat', age='3', pet_photo='images/Ben.jpg'):
    ...
    name = 'Кручу верчу запутать хочу и снова кручу верчу запутать хочу вот'
...
def test_add_pet_with_special_characters_in_variable_animal_type(name='Ben', age='3', pet_photo='images/Ben.jpg'):
...
def test_add_pet_with_numbers_in_variable_animal_type(name='Ben', animal_type='34562', age='5',
                                                      pet_photo='images/Ben.jpg'):
...
def test_add_pet_with_a_lot_of_words_in_variable_animal_type(name='Ben', age='2', pet_photo='images/Ben.jpg'):
    ...
    animal_type = 'пудель стаф мопс йорк чеширский кот норвежская полосатая корги спаниэль вислоухий'
